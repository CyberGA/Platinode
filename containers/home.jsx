    ...
    <div className="flex flex-col">
      <div className="bg-white px-[15vw]">
        <div className="w-full text-center text-[64px] font-bold text-secondary my-[120px]">
          <div>
            <h1 className="text-primaryText font-light">
        ...
        <div className="flex flex-row items-center justify-center gap-x-6 border bg-secondaryLight rounded-lg mb-[160px] clip shadow-md shadow-black/10">
          <div className="flex flex-col gap-y-6 p-8 w-full">
            <h2 className="text-primaryText text-[28px] font-bold max-w-sm">
              GET SUPPORT GLOBALLY
            </h2>
            <p className="max-w-lg text-[18px] text-primaryText">
              Do you have a project idea but no capital or funds to see the project to completion?
              Try out platinode now, and see your project go live in no time. Get support from all over the world
            </p>
          </div>
