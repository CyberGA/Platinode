...
export default function CreateProjectContainer() {
  ...
  const { address, setLoading, createProject } = useGlobalContext();
      ...
      <div className="flex flex-col items-center w-full bg-white py-10 px-2 sm:px-20 rounded-lg">
        ...
        >
          ...
          <div className="mt-5">
            <button
              type="submit"
              className="bg-secondary text-[18px] text-primaryText py-5 px-8 w-full rounded-lg font-plat font-bold"
            >
              SUBMIT
            </button>
          </div>
